...
function Enemy(type){
	...
	// this.speed = pps; //速度
	// this.hp = 1; //血量
	// this.score = pps; //敌机的分数
    const pps = 10; //ES6定义常量
    this.dieImgs = []; //爆炸时的图片数组
    [this.ele ,this.id ,this.speed ,this.speed ,this.hp ,this.score] = [document.createElement("div") , parseInt(Math.random()*100000000), pps , 1 , pps  ] ;//ES6结构赋值****
